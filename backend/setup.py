#!/usr/bin/env python
"""
Package metadata for openedx_ai_badges.
"""
...
VERSION = get_version("openedx_ai_badges", "__init__.py")
...
setup(
    ...
    version=VERSION,
    description="""A experimental plugin for Open edX designed to explore AI extensibility""",
    long_description=README + "\n\n" + CHANGELOG,
    author="Open edX Project",
    author_email="oscm@openedx.org",
    url="https://github.com/openedx/openedx-ai-badges",
    packages=find_packages(
        include=["openedx_ai_badges", "openedx_ai_badges.*"],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "openedx_ai_badges = openedx_ai_badges.apps:OpenedxAIBadgesConfig",
        ],
        "cms.djangoapp": [
            "openedx_ai_badges = openedx_ai_badges.apps:OpenedxAIBadgesConfig",
        ],

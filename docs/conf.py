...
html_context = {
    ...
    "github_repo": 'openedx-ai-badges',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/openedx-ai-badges",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    source_path = os.path.join(root_path, 'backend', 'openedx_ai_badges')
